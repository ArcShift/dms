...
class M_setup extends CI_Model {
    ...
    function core_table() {
        ...
        $module = array(
            ...
            array('id' => '5', 'name' => 'dashboard','on_menu' => 'YES', 'icon' => 'home','title' => 'Dashboard'),
            ...
            array('id' => '12', 'name' => 'treeview_detail', 'on_menu' => 'YES', 'icon' => 'braille', 'title' => 'Manajemen Standar Perusahaan','parent'=> 'user_data', ),
