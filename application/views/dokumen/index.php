...
//            tbJadwal.columns(6).visible(false);
    ...
    function detailDocument(index) {
        ...
        var data = {
            ...
            'Letak Pasal Pada Dokumen': '<div style="white-space: pre-wrap; max-height: 120px; overflow-y:auto">' + (d.deskripsi == null ? '-' : d.deskripsi) + '<div>',
            Judul: d.judul,
    ...
    function detailDistribusi(index) {
        ...
        var data = {
            ...
            'Dokumen Terkait': doc,
            'Pembuat Dokumen': d.creator_name,
            Distribusi: d.txtDistribusi,
        }
        showDetail('Detail Distribusi', data, 3);
    }
