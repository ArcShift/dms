    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group col-sm-5">
                <input class="form-control" type="date" name="jadwal" id="form2-jadwal">
            </div>
            <div class="form-group col-sm-5">
                <select class="form-control" id="form2-anggota" name="anggota">
            ...
            <div class="form-group col-sm-2">
                <button type="button" class="btn btn-primary fa fa-plus" id="form2-tambah" value="ok"></button>
            </div>
        </div>
        <div>
