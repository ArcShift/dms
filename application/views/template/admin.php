...
$menus = [
    ...
    ['type' => 'parent', 'name' => 'manajemen pengguna'],
    ['type' => 'child', 'name' => 'perusahaan', 'href' => 'tugas', 'icon' => 'chalkboard-teacher'],
    ['type' => 'child', 'name' => 'unit kerja', 'href' => 'dokumen', 'icon' => 'copy'],
    ['type' => 'child', 'name' => 'personil', 'href' => 'pasal', 'icon' => 'book'],
    ['type' => 'child', 'name' => 'akun', 'href' => 'jobdesk', 'icon' => 'id-badge'],
    ['type' => 'parent', 'name' => 'pasal standar'],
    ['type' => 'child', 'name' => 'daftar standar', 'href' => 'pasals', 'icon' => 'book'],
    ['type' => 'child', 'name' => 'standar perusahaan', 'href' => 'pasals', 'icon' => 'book'],
    ['type' => 'child', 'name' => 'deskripsi pasal', 'href' => 'pasals', 'icon' => 'book'],
    ['type' => 'child', 'name' => 'pemahaman pasal', 'href' => 'pasals', 'icon' => 'book'],
    ['type' => 'child', 'name' => 'bukti pasal', 'href' => 'pasals', 'icon' => 'book'],
    ['type' => 'parent', 'name' => 'gap analisa'],
    ['type' => 'child', 'name' => 'jadwal gap analisa', 'href' => 'aktifitas', 'icon' => 'archive'],
    ['type' => 'child', 'name' => 'gap analisa', 'href' => 'aktifitas', 'icon' => 'archive'],
    ['type' => 'child', 'name' => 'perbaikan gap analisa', 'href' => 'aktifitas', 'icon' => 'archive'],
    ['type' => 'parent', 'name' => 'riwayat'],
    ['type' => 'child', 'name' => 'aktifitas pengguna', 'href' => 'akun', 'icon' => 'user'],
    ['type' => 'parent', 'name' => 'pengaturan'],
    ['type' => 'child', 'name' => 'pengaturan', 'href' => 'akun', 'icon' => 'user'],
//    ['type' => 'child', 'name' => 'akun', 'href' => 'akun', 'icon' => 'user'],
    ['type' => 'parent', 'name' => 'panduan'],
    ['type' => 'child', 'name' => 'panduan', 'href' => 'notif', 'icon' => 'envelope'],
];
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="index3.html" class="nav-link"><?= $this->config->item('app_name') ?></a>
                    </li>
                </ul>
                <!-- Right navbar links -->
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <?php foreach ($menus as $m) { ?>
                                <?php if ($m['type'] == 'parent') { ?>
                                    <li class="nav-header"><b><?= strtoupper($m['name']) ?></b></li>
                                <?php } elseif ($m['type'] == 'child') { ?>
                                    <li class="nav-item">
                                        <a href="<?= site_url('admin/' . $m['href']) ?>" class="nav-link <?= $m['href'] == $this->uri->segment(2) ? 'active' : '' ?>">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="direct-chat-messages">
                                            ...
                                            <div class="direct-chat-msg">
                                                ...
                                                <!-- /.direct-chat-infos -->
                                                <img class="direct-chat-img" src="assets/admin-lte/dist/img/user1-128x128.jpg" alt="message user image">
                                                <!-- /.direct-chat-img -->
