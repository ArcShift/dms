            ...
            <div class="tab-pane" id="tab-c<?= $c['id'] ?>" role="tabpanel">
                ...
                <ul class="nav nav-tabs">
                    <?php foreach ($c['standard'] as $k2 => $s) { ?>
                        <li class="nav-item"><a data-toggle="tab" href="#tab-s<?= $s['id'] ?>" class="nav-link" onclick="getGrafik(<?= $c['id'] . ',' . $s['id_standard'] ?>)"><?= $s['name'] ?></a></li>
                    <?php } ?>
                </ul>
                <div class="tab-content">
                    <?php foreach ($c['standard'] as $k => $s) { ?>
                        <div class="tab-pane" id="tab-s<?= $s['id_standard'] ?>" role="tabpanel">
                        </div>
                    <?php } ?>
                </div>
                <!--aa-->
